...
// ... client and serverUrl declarations ...
...
void main() async {
  ...
  // Initialize AppState (loads saved preferences).
  await AppState().initialize();

  // Initialize the background service (this does not start it).
  await ButlerBackgroundService().initialize();
