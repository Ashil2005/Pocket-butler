...
abstract class User implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  factory User.fromJson(Map<String, dynamic> jsonSerialization) {
    return User(
      ...
      secondaryDeviceToken:
          jsonSerialization['secondaryDeviceToken'] as String?,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (secondaryDeviceToken != null)
        'secondaryDeviceToken': secondaryDeviceToken,
    };
  }
...
class _UserImpl extends User {
  ...
  User copyWith({
    ...
    Object? secondaryDeviceToken = _Undefined,
  }) {
    return User(
      ...
      secondaryDeviceToken: secondaryDeviceToken is String?
          ? secondaryDeviceToken
          : this.secondaryDeviceToken,
    );
  }
...
class UserUpdateTable extends _i1.UpdateTable<UserTable> {
  ...
  _i1.ColumnValue<String, String> secondaryDeviceToken(String? value) =>
      _i1.ColumnValue(
        table.secondaryDeviceToken,
        value,
      );
}
...
class UserTable extends _i1.Table<int?> {
  UserTable({super.tableRelation}) : super(tableName: 'user') {
    ...
    secondaryDeviceToken = _i1.ColumnString(
      'secondaryDeviceToken',
      this,
    );
  }
  ...
  late final _i1.ColumnString secondaryDeviceToken;
